...
YUMI_PICS = [
    "https://files.catbox.moe/9mqfbh.jpg",
    "https://files.catbox.moe/0r05oi.jpg",
    "https://files.catbox.moe/duqad3.jpg",
    "https://files.catbox.moe/encwa0.jpg",
    "https://files.catbox.moe/0hiait.jpg",
]
...
async def start_pm(client, message: Message, _):
    ...
    try:
        stk = await message.reply_sticker("CAACAgUAAxkBAAIXY2pE_sjucjC9aolPazSntTJ4nTreAAI9HAACyH_AVvV3F0pMg2EiPAQ")
    ...
    await asyncio.sleep(0.4)
    await loading_1.edit_text("<emoji id='5413840936994097463'>🌺</emoji> <b> 𝐙ʏʀᴀ 𝗫 𝐌ᴜꜱɪᴄ ♪\nsᴛᴧʀᴛed!</b>")
